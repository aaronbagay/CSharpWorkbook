    ...
    public class Tab
    {
        ...
        public class TabController : IEnumerable<Tab>
        {
            ...
            public void MoveToEnd(Tab tab)
            {
                ...
                {
                    _tabs.Add(tab);
                    Console.WriteLine($"Moved {tab} to end. Index = {tab.IndexOf(tab)}");
                }
            }
        ...
        static class Program
        {
            public static void Main()
            {
                ...
                var mscoft = controller.OpenNew("microsoft.com");
            ...
            private static void LogTabs(this IEnumerable<Tabs> tabs)
            {
                Console.WriteLine("TABS: | ");

                foreach (var tab in tabs)
                    Console.Writ($"{tab.Url.PadRight(15)} |")
                Console.WriteLine();
            }
        }
    }
