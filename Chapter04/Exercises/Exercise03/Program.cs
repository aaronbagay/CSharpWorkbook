...
namespace Chapter04.Exercises.Exercise03
{
    class Program
    {
        ...
        public static void Main ()
        {
            ...
            var filteredCountries = countries.Where(c => requiredContinents.Contains(c.Continent))
            .OrderBy(c => c.Continent).ThenBy(c => c.Area).Select( (city, i) => new {Index = i, Country = city});
