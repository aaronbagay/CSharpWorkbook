    ...
    record TravelLog (string Name, int Distance, int Duration)
    {
        ...
        class LinqMultipleEnumerationExample
        {
            public static void Main()
            {
                ...
                var fastestJourneysList = travelLogs.Where(t1 => t1.AverageSpeed()> 50).ToList();
                for (var i = 0; i < 2; i++)
                {
